# Toplevel rule
- Before committing or reporting completion, review the final diff and verify that every change is necessary for the user's request. Remove unrelated changes you introduced, and preserve the user's existing changes.
- Write comments in the code in English, keeping them short and concise
- Write Git commit messages in English, keeping them short and concise
- Keep README changes concise, focusing on essential instructions and caveats.
- Git commits, pushes, and the creation of pull requests should only be performed after the user has given permission
- Write Git commit messages in English, keeping them short and concise
- Write Pull Request comments in English, keeping them short and concise
